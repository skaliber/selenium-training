...
Selenium.prototype.doOpen = function(url) {
   ...
   * due to security restrictions in the driver (Same Origin Policy). If you
   * need to open an URL on another domain, use the Selenium Server to start a
   * new driver session on that domain.
   *
...
Selenium.prototype.doSelectWindow = function(windowID) {
   ...
   * <p>1.) if windowID is null, (or the string "null") then it is assumed the user is referring to the original window instantiated by the driver).</p>
...
Selenium.prototype.getWhetherThisFrameMatchFrameExpression = function(currentFrameString, target) {
     ...
     * driver frame and window, and sometimes the selenium server needs to identify
...
Selenium.prototype.doGoBack = function() {
    /**
     * Simulates the user clicking the "back" button on their driver.
     *
     */
...
Selenium.prototype.doRefresh = function() {
    /**
     * Simulates the user clicking the "Refresh" button on their driver.
     *
     */
...
Selenium.prototype.getAllWindowIds = function() {
  /** Returns the IDs of all windows that the driver knows about in an array.
   *
   * @return string[] Array of identifiers of all windows that the driver knows about.
   */
   return this.getAttributeFromAllWindows("id");
};

Selenium.prototype.getAllWindowNames = function() {
  /** Returns the names of all windows that the driver knows about in an array.
   *
   * @return string[] Array of names of all windows that the driver knows about.
   */
   return this.getAttributeFromAllWindows("name");
};

Selenium.prototype.getAllWindowTitles = function() {
  /** Returns the titles of all windows that the driver knows about in an array.
   *
   * @return string[] Array of titles of all windows that the driver knows about.
   */
...
Selenium.prototype.doAllowNativeXpath = function(allow) {
    /**
    * Specifies whether Selenium should use the native in-driver implementation
    * of XPath (if any native version is available); if you pass "false" to
    * this function, we will always use our pure-JavaScript xpath library.
    * Using the pure-JS xpath library can improve the consistency of xpath
    * element locators between different driver vendors, but the pure-JS
...
Selenium.prototype.doSetBrowserLogLevel = function(logLevel) {
    /**
    * Sets the threshold for driver-side logging messages; log messages beneath this threshold will be discarded.
    * Valid logLevel strings are: "debug", "info", "warn", "error" or "off".
    * To see the driver logs, you need to
    * either show the log window in GUI mode, or enable driver-side logging in Selenium RC.
    *
